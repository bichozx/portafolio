...
export const Servicios = () => {
  return (
    <div className="flex justify-center items-center bg-gray-100 py-8">
      <div className="max-w-4xl w-full px-6 py-8 bg-gray-100 rounded-lg shadow-lg">
        <div className="text-center mb-8">
          <h1 className="text-5xl font-bold text-gray-800">Servicios</h1>
        ...
        <section className="space-y-8">
          ...
          <article className='rounded-lg shadow-lg'>
            ...
            <p className="text-gray-700">
              ...
              eficiente. Experiencia en el seguimiento y corrección de errores
              en el código, así como en la implementación de soluciones
              efectivas.
            </p>
          </article>
          ...
          <article className='rounded-lg shadow-lg'>
            ...
            <p className="text-gray-700">
              ...
              Experiencia en la colaboración con otros desarrolladores a través
              de la creación de ramas, la realización de pull requests y la
              revisión de código.
            </p>
          </article>
        </section>
